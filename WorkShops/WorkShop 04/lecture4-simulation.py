...
class IRLAgentPlus:
    ...
    def chooseAction(self, rand=True, actAvoid=0):
...
#####################################################################################################
##########################~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##########################
# This class "IRLAgent" from workshop 3 where the human give feedback only when the robot take a step.
# To enable and disable this class you need to go down to "Main" and comment and uncomment whatever
# you want to run.
##########################~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##########################
#####################################################################################################
